  ...
  return (
    <section>
      ...
      <div className="flex flex-col gap-3">
        ...
        {selectedExperiment &&
          Object.keys(selectedExperiment.param_schema?.properties ?? {})
            .length > 0 && (
            <div className="p-4 rounded-xl border border-[var(--color-border)] bg-[var(--color-surface)] animate-fade-up">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {Object.entries(selectedExperiment.param_schema.properties).map(
                  ([key, schema]) => (
                      ...
                      <input
                        ...
                        value={String(
                          experimentParams[key] ??
                            selectedExperiment.default_params[key] ??
                            "",
                        )}
                        onChange={(e) =>
                          updateExperimentParam(key, Number(e.target.value))
                        }
